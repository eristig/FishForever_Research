...
gov_ols <- polr(cluster_no ~ gov_law + gov_practice + country + x19_current_fish_catch, data = gov_data, Hess = TRUE)
summary(gov_ols)
...
gov_ols <- polr(cluster_no ~ gov_law + gov_practice + country + x49_enforcement_responsible, data = gov_data, Hess = TRUE)
summary(gov_ols)
...
gov_ols <- polr(cluster_no ~ gov_law + gov_practice + country + x54_food_availability, data = gov_data, Hess = TRUE)
summary(gov_ols)
