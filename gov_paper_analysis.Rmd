...
```{r}
# Chi-square tests for independence + correlation plots
chi1 <- chisq.test(gov_data$gov_law, gov_data$country, correct=F)
print(chi1)
...
chi3 <- chisq.test(gov_data$gov_law, gov_data$cluster_no, correct=F)
print(chi3)

corrplot(chi3$residuals, is.cor = FALSE)

chi4 <- chisq.test(gov_data$gov_practice, gov_data$cluster_no, correct=F)
print(chi4)

corrplot(chi4$residuals, is.cor = FALSE)

chi5 <- chisq.test(gov_data$cluster_no, gov_data$country, correct=F)
print(chi5)

corrplot(chi5$residuals, is.cor = FALSE)

chi6 <- chisq.test(gov_data$gov_law, gov_data$x49_enforcement_responsible, correct=F)
print(chi6)

corrplot(chi6$residuals, is.cor = FALSE)

chi7 <- chisq.test(gov_data$gov_practice, gov_data$x49_enforcement_responsible, correct=F)
print(chi7)
```

```{r}
# Visualizing n's for small n answers
