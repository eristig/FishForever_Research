...
- size
- cluster (which clsuter each observation is in)
...
we're rwturning to this Tuesday. 
...
ggplot(data = x44_counts,
 ...
 geom_bar( stat="identity", fill="goldenrod") +
  theme_bw()
```
*Question 44:  Mean = 0.318, but nearly all respondents said Yes or No. Around 1200 responses did not attend meetings, will around 1600 do attend.*
