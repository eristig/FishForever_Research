...
agree_engage_only <- scaled_sum %>% 
  select(24:28, 29:30, 32:38)


cluster_number_est_2 <- NbClust(agree_engage_only[1:14], min.nc = 2, max.nc = 8, method = "kmeans")

cluster_number_est_2


agreement_engagement_km <- kmeans(agree_engage_only, X_X) ## The 4 means the amount of clusters we're looking at
