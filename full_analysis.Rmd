...
scaled_sum <- hhs_scaled %>% 
 rowwise() %>% 
  mutate(eng_sum = sum(x44_scaled + x45_scaled + x48_scaled + x48_scaled + x53_scaled + x61g_scaled)) %>% 
  mutate(agree_sum = x10_scaled + x43_scaled + x46_scaled + x47_scaled + x52_scaled + x61a_scaled + x61f_rights_distribution_fair + x62_scaled + x64_scaled)
